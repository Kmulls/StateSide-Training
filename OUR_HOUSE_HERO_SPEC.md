...
- Headline (H1), two forced lines:
  Line 1: You bring the gift,
  Line 2: We build yOUR HOUSE around it.
  (the "yOUR HOUSE" capitalization is deliberate — OUR HOUSE inside "your
  house". Was "You create the magic. We build what carries it."; changed
